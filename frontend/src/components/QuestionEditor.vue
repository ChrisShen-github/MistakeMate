...
const isImageOnly = computed(() => draft.is_image_only)
const circledLabels = ['①', '②', '③', '④', '⑤', '⑥', '⑦', '⑧', '⑨', '⑩']
...
<template>
  <article class="question-editor" :aria-labelledby="`question-${question.id}`">
    ...
    <section v-if="!hasParts && !isImageOnly" class="options-section" aria-labelledby="options-heading">
    ...
    <section v-if="!isImageOnly" class="structure-section" aria-labelledby="structure-heading">
...
.clean-source-section { display: grid; grid-template-columns: minmax(0,1fr) minmax(180px,360px); gap: 16px; align-items: center; margin-top: 16px; padding: 14px; border: 1px solid #c6e3d6; border-radius: 10px; background: #f5fcf8; }.clean-source-section > div { display: grid; gap: 4px; }.clean-source-section strong { color: #286148; font-size: 14px; }.clean-source-section small { color: #5a7d6b; font-size: 12px; line-height: 1.55; }.clean-source-section img { display: block; width: 100%; max-height: 260px; object-fit: contain; background: #fff; border: 1px solid #d7e9df; border-radius: 8px; }
